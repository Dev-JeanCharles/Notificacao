...
public class EmailService {
    ...
    public void enviaEmail(TarefasDTO dto) {
        try {
            ...
            mimeMessageHelper.setTo(InternetAddress.parse(dto.getEmail()));
            ...
            context.setVariable("dataCriacao", dto.getDataCriacao());
            context.setVariable("dataAlteracao", dto.getDataAlteracao());
